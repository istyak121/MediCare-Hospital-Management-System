    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Write Prescription</h1>
            <p className="text-sm text-text-muted">Digital prescription writer with medicine search, dosage calculator, and interaction checks.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-border shadow-sm p-12">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 rounded-full bg-bg-tertiary flex items-center justify-center mb-4">
            <FilePlus className="w-8 h-8 text-text-muted" />
          </div>
