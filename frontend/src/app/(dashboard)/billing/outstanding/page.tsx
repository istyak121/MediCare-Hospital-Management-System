    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Outstanding Bills</h1>
            <p className="text-sm text-text-muted">Track overdue payments and send payment reminders to patients.</p>
          </div>
        </div>
      </div>
