    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-2xl font-bold text-text-primary">Invoice Details</h1>
            <p className="text-sm text-text-muted">View invoice breakdown, payment history, and download PDF receipt.</p>
          </div>
        </div>
      </div>
