...
import { PillBottle, ArrowRight } from 'lucide-react';
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            ...
            <p className="text-sm text-text-muted">Pending prescriptions, inventory alerts, and dispensing queue will appear here.</p>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-lg border border-border shadow-sm p-12">
        <div className="flex flex-col items-center justify-center text-center">
          <div className="w-16 h-16 rounded-full bg-bg-tertiary flex items-center justify-center mb-4">
            <PillBottle className="w-8 h-8 text-text-muted" />
          </div>
